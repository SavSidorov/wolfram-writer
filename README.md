Text editor with inline Wolfram|Alpha API calls. This makes the document more dynamic and interactive, and allows you to do computations and information search inline, reducing context-switching.
